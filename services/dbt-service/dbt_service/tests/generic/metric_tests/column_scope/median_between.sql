{% test median_between(model, column_name, min_value=None, max_value=None, respect_nulls=false) %}
...
(
    SELECT
        ...
        'min_value = {{min_value}}, max_value = {{max_value}}, respect_nulls = {{respect_nulls}}' AS test_params,
